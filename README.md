...
### 목표
NYC 택시 데이터를 기반으로 한 요금 예측 시스템을 개발하고, BigQuery ML과 로컬 XGBoost 모델을 활용한 비교 분석을 통해 예측 정확도를 높이는 것을 목표로 합니다.
...
### 사용 데이터셋
- **Dataset**: `new_york_yellow_taxi_tripdata_2024`
- **출처**: [Kaggle - NYC Yellow Taxi Trip Records 2024](https://www.kaggle.com/datasets/maxkharlam/nyc-yellow-taxi-trip-records-2024)

2024년도 NYC 택시 운행 데이터를 사용하여 요금 예측 모델을 구축했습니다.
